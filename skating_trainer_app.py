...
from skating_quiz import QuizLoader, PenaltiesQuizScreen, resource_path as quiz_resource_path
from skating_quiz_plus import RecallQuizLoader, RecallQuizScreen, resource_path as recall_resource_path
